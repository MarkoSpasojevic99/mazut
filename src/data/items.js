const items = {
  draft_beers: [
    { id: 1, name: { en: 'Example Draft Beer 1', sr: 'Primer Točeno Pivo 1', ru: 'Пример разливного пива 1' }, brewery: 'example', imageName: 'example-draft-beer-1.png' },
    { id: 2, name: { en: 'Example Draft Beer 2', sr: 'Primer Točeno Pivo 2', ru: 'Пример разливного пива 2' }, brewery: 'example', imageName: 'example-draft-beer-2.png' },
    // Dodaj još draft piva ovde
  ],
  bottled_beers: [
